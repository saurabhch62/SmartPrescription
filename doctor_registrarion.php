...
$doctor_photo =$_POST["doctor_photo"];
...
echo "Connected successfully";
       ...
       $sql = "INSERT INTO `doctor_registration` (`S No.`, `doctor_vnpi`, `doctor_name`, `doctor_gender`, `doctor_age`, `doctor_designation`, `dpctor_email`, `doctor_password`, `doctor_mobile`, `clinic_address`, `doctor_photo`,`verified`) VALUES (NULL, '".$doctor_npi."', '".$doctor_name."', '".$doctor_gender."', '".$doctor_age."', '".$doctor_designation."', '".$doctor_password."', '".$doctor_mobile."', '".$clinic_address."', '".$doctor_photo."', '".$doctor_verification_status."');";
